select COUNT(ArapReceivePaymentDTO.ID) from ARAP_ReceivePayment as ArapReceivePaymentDTO
where (ArapReceivePaymentDTO.auditor is Null or ArapReceivePaymentDTO.auditor='') and ArapReceivePaymentDTO.isReceiveFlag = 1 
and (1=1 and {ArapReceivePaymentDTO.Idpartner_PartnerDTO} 
